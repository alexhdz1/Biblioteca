...
public class ProfesorController {
    ...
    public boolean registrarProfesor() {
        String ePattern = "^[_a-zA-Z0-9-]+(\\.[_a-zA-Z0-9-]+)*@ciencias.unam.mx";
        String numTrab = "^[0-9]+";
                ...
                if (matcher.matches()) {
                    if (mat.matches()) {
                        ...
                        if (mat1.matches()) {
                            ...
                            jpa.guardar(profesor);
                            lista = jpa.findProfesorEntities();
                            String[] params = {"biopractice20191@gmail.com", "Biopractice1234", profesor.getCorreo(), "smtp.gmail.com", "587", "Confirma tu correo", "La cuenta de correo:" +profesor.getCorreo()+"\n ah sido confirmada."};
